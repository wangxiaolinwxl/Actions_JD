...
const shareCodes = [
  {
    ...
    nc: $.getdata("nc_shareCode1") || "03cba0950aa2448ab843fe47690d916c",
  ...
  },
  {
    ...
    nc: $.getdata("nc_shareCode2") || "3f0cfe9b5b5c425d9a291c95a550e6ad",
  ...
  },
  {
    ...
    mc: $.getdata("mc_shareCode3") || "MTE1NDAxNzcwMDAwMDAwMzc5Mzc1NjU=",
...
!(async () => {
  ...
  for (let i = 0; i < shareCodes.length; i++) {
    const { zd, nc, mc, ddgc, jxgc, jxzz } = shareCodes[i];
    await $.wait($.random);
    zd &&
      (await create(
